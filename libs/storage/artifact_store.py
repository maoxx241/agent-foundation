...
from libs.schemas import ArtifactStage, TaskBrief, TaskState, TaskStateRecord
from libs.schemas.artifacts import (
    ADR,
    DesignReview,
    DesignSpec,
    EvidencePack,
...
class ArtifactStore:
    ...
    def get_task(self, task_id: str) -> dict[str, Any]:
        ...
        task_brief = read_json(task_root / ArtifactStage.task.value / "task-brief.json")
        state = read_json(task_root / ArtifactStage.task.value / "state.json")
    ...
    def get_state(self, task_id: str) -> dict[str, Any]:
        task_root = self.task_root(task_id)
        return read_json(task_root / ArtifactStage.task.value / "state.json")
